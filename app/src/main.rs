        ...
        transitions: vec![
            Transition {
                ...
                condition: Expression::BinaryOperation {
                    ...
                    left: Box::new(Expression::Identifier("in1".to_string())),
                    right: Box::new(Expression::Number(Number::Decimal(0, "1".to_string()))),
                },
            },
            Transition {
                from: "s1".to_string(),
                ...
                condition: Expression::BinaryOperation {
                    op: BinaryOperator::Eq,
                    left: Box::new(Expression::Identifier("in2".to_string())),
                    right: Box::new(Expression::Number(Number::Decimal(0, "1".to_string()))),
                },
            },
        ],
